...
<br>
  ...
  ?>
  <!-- Display records to delete-->
		<div class="container">
      <br><br>
      <h2><br>Delete Product</h2>
      <p style="font-size: 18px;">You can delete products here.</p> <br>           
      ...
      <table class="table table-hover">
        ...
        <?php while ($row= mysqli_fetch_array($select_query_result)) {?>
          <tr>
            <!-- remove button which redirects to remove-product.php to delete it -->
            <td><a href="remove-product.php?p_id=<?php echo $row['p_id'];?>" data-toggle="tooltip" data-placement="left" title="Remove item"><span class="glyphicon glyphicon-trash"></span></a></td>
            <td><?php echo $i; $i++; ?></td>
    ...
    <!-- bootstrap tooltip script start-->
     <script>
